        ...
        >
          <Box width={{ base: "100%", md: "30%" }}>
            <Text fontWeight={500} fontSize={{ base: "1.3rem", lg: "1.5rem" }}>
              THE ART OF VISUALIZATION IS A BLEND OF ARTISTIC AND TECHNICAL
              FLAIR.
            </Text>
            <Text
              textTransform={"uppercase"}
              ...
              pt={"1rem"}
            >
              The history begins with a highly ambitious individual. Our
              founder, a well-educated and skilled graduate in this field, has
              revolutionized architectural design and visualization. With an
              international impact, we&apos;ve created a portfolio of{" "}
              <b>305+</b> realistic images from about <b>47</b> projects
              worldwide.
            </Text>
          </Box>
          ...
          >
            ...
            >
              ...
              acclaim. We&apos;ve turned architectural visualization into an
              art, blending technology and creativity to depict projects
              pre-construction.
            </Text>
          </Box>
